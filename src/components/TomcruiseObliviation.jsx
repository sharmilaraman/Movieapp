...
import '../components/TomcruiseObliviation.css';
...
const TomcruiseObliviation = () => {
  ...
  return (
    <div className='movie-details-container'>
      ...
      <p className="breadcrumb">Home &gt;&gt; Movies &gt;&gt; Tom Cruise Oblivion</p>
      <h2 className="title">Tom Cruise Obliviation</h2>
      </div>
      <main className="content">
        ...
        <div className="movie-data">
          ...
          <p>
            <strong>Genre:</strong> Comedy, Action, Bollywood
          </p>
          <p>
            <strong>Year:</strong> 2015
          </p>
          <p>
            <strong>Artist:</strong> Naga Pesto
          </p>
        </div>
        ...
        <div className="right-section">
          <div className="movie-image-container">
            <img src={MainImage}  className="movie-image" />
...
export default TomcruiseObliviation